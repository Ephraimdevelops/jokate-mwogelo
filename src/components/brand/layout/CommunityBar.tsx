...
export function CommunityBar() {
  return (
    <section className="bg-brand-black w-full border-t border-brand-accent py-section-sm">
      <Container className="flex flex-col items-center justify-center text-center space-y-8">
        ...
        >
          ...
          <span className="relative z-10 flex items-center gap-2">
            Subscribe to the Newsletter <span className="text-brand-accent font-sans text-[16px] leading-[0] ml-1">→</span>
          </span>
        </Link>
      </Container>
    </section>
