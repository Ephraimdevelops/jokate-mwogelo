...
export function PillarBar() {
  return (
    <SectionWrapper bg="black" className="py-12 max-sm:py-8 lg:px-0 lg:max-w-none">
      <div className="w-full max-w-[1440px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 divide-y md:divide-y-0 md:divide-x divide-brand-gold/30">
        {pillars.map((pillar, i) => (
          ...
          >
             <span className="text-brand-gold text-label mb-2 block">{pillar.label}</span>
